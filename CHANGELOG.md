...
- Add `Render` util to recreate rendered Html or Markdown formatted text from text/caption and `MessageEntity` ([PR 1060](https://github.com/teloxide/teloxide/pull/1060))
